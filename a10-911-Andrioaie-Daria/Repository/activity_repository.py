...
from Domain.activity_entity import ActivityException, Activity
from iterable_data_structure import Iterable


class ActivityRepositoryException(ActivityException):
...
class ActivityRepository:
    ...
    def __init__(self):
        self._chronological_list_of_activities = Iterable()
    ...
    def find_available_gap_in_list(self, new_activity):
        ...
        if not found_activity_in_the_given_day:
            ...
            if len(self.chronological_list) == 0:
                return 0
            # before the first activity
            elif day_of_activity < self.chronological_list[0].date:
                return 0
    ...
    def remove_activity(self, id_of_activity):
        ...
        removed_activity = self.chronological_list.__getitem__(index_of_activity)
        self.chronological_list.__delitem__(index_of_activity)
    ...
    def initialise_10_activities(self):
        """
        ...
        for index in range(0, 10):
            ...
            self.chronological_list.append(new_activity)
