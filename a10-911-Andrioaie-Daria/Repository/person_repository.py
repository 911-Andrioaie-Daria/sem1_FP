...
from Domain.person_entity import Person, PersonException
from iterable_data_structure import Iterable


class PersonRepositoryException(PersonException):
...
class PersonRepository:
    ...
    """
    def __init__(self):
        self._current_list_of_persons = Iterable()
    ...
    def remove_person(self, id_of_person):
        # FIXME does not return the removed person
        """
        ...
        removed_person = self.current_list[person_index]
        # removed_person = self.current_list.__getitem__(person_index)

        del self.current_list[person_index]
        # self.current_list.__delitem__(person_index)
