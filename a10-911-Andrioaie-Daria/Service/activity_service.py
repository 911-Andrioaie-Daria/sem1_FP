...
class ActivityService:
    ...
    def get_all_activities_in_a_day(self, user_date):
        ...
        list_of_activities = self.get_all_activities()
        resulted_activities = list_of_activities.filter_data(lambda activity: activity.date == user_date)
    ...
    def get_the_busiest_days(self):
        ...
        resulted_days.sort_data(lambda day1, day2: day1.free_time <= day2.free_time)
    ...
    def get_all_activities_with_a_person(self, id_of_person):
        ...
        if id_of_person > 0:
            resulted_activities = list_of_activities.filter_data(
                lambda activity: id_of_person in activity.list_of_persons)
            # for activity in self.get_all_activities():
        ...
        # If the id is zero, the method searches for activities that the user will do alone, without other persons
            ...
            resulted_activities = list_of_activities.filter_data(
                lambda activity: not activity.list_of_persons)
            # for activity in self.get_all_activities():
