...
class TestPersonRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._person_repository.initialise_persons()
    ...
    def test_get_item(self):
        person = self._person_repository.get_item(1)
        self.assertIsInstance(person, Person)

    def test_current_list_setter(self):
        new_list = [1, 2, 3]
        self._person_repository.current_list = new_list

        self.assertEqual(self._person_repository.current_list, [1, 2, 3])
...
class TestActivityRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._activity_repository.initialise_10_activities()
        my_list_of_activities = [
            Activity(1, [1, 2, 3], date(2020, 12, 15), time(9), time(12), 'activity 1'),
            Activity(2, [], date(2020, 12, 16), time(9), time(12), 'activity 2'),
            Activity(3, [1, 3, 5, 9], date(2020, 12, 17), time(9), time(12), 'activity 3'),
            Activity(4, [10], date(2020, 12, 18), time(9), time(12), 'activity 4'),
            Activity(5, [3], date(2020, 12, 19), time(9), time(12), 'activity 5'),
            Activity(6, [], date(2020, 12, 20), time(9), time(12), 'activity 6'),
            Activity(7, [2], date(2020, 12, 21), time(9), time(12), 'activity 7'),
            Activity(8, [], date(2020, 12, 22), time(9), time(12), 'activity 8'),
            Activity(9, [1], date(2020, 12, 23), time(9), time(12), 'activity 9'),
            Activity(10, [5, 7, 3], date(2020, 12, 24), time(9), time(12), 'activity 10')]
    ...
    def test_add_activity(self):
        ...
        self.assertEqual(17, self._activity_repository.available_id)
