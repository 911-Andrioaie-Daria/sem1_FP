...
class TestActivity(unittest.TestCase):
    ...
    def test_activity(self):
        ...
        length_of_activity = new_activity.length_of_activity()
        self.assertEqual(length_of_activity, timedelta(seconds=14400))
...
class TestActivityValidator(unittest.TestCase):
    ...
    def test_activity_validator(self):
        ...
        activity1 = Activity(12, [1], date(2021, 12, 30), time(12, 30), time(15, 30), 'alabalaportocala')
        trustworthy_validator.validate_activity(activity1)

        # the id field must not be empty
        activity2 = Activity("", [], date(2021, 11, 1), time(12, 30), time(9), "")
        try:
        ...
        activity9 = Activity(-12, [1], date(2021, 12, 30), time(12, 30), time(15, 30), 'alabalaportocala')
        try:
        ...
        activity3 = Activity(12, ['@:{'], date(2020, 12, 30), time(12, 30), time(15, 30), 'alabalaportocala')
        try:
        ...
        activity6 = Activity(12, [1], date(2020, 12, 30), "", time(15, 30), 'alabalaportocala')
        try:
        ...
        activity7 = Activity(12, [1], date(2020, 12, 30), time(12), time(9), 'alabalaportocala')
        try:
        ...
        activity8 = Activity(12, [1], date(2020, 12, 30), time(12, 30), time(15, 30), "")
        try:
